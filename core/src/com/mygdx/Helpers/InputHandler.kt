...
class InputHandler (private val field : HexField, val height : Int, val resolutionMultiplier : Float, val playerInd: Int) : InputProcessor {
    var dataHasBeenGot = false//for different players.
